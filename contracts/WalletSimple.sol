 ...
 * Typically used in a 2-of-3 signing configuration. Uses ecrecover(or polyRecover in polyjuice) to allow for 2 signatures in a single transaction.
 *
...
contract WalletSimple {
    ...
    /**
     * Gets signer's address using ecrecover(or polyRecover in polyjuice)
     * @param operationHash see Data Formats
     * @param signature see Data Formats
